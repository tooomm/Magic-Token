...
**To add tokens manually to Cockatrice, safe the XML database with a right click on the file &rarr; `Save Link As...`** (not perfect, because no description on how to import to the programm)<br>
